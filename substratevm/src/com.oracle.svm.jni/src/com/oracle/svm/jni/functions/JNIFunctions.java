...
public final class JNIFunctions {
    ...
    @CEntryPointOptions(prologue = JNIEnvEnterReturnNullHandleOnFailurePrologue.class)
    ...
    @CEntryPointOptions(prologue = JNIEnvEnterReturnEDetachedOnFailurePrologue.class)
    ...
    @CEntryPointOptions(prologue = JNIEnvEnterReturnNullWordOnFailurePrologue.class)
    ...
    @CEntryPointOptions(prologue = JNIEnvEnterReturnMinusOneOnFailurePrologue.class)
