...
* _You will need to set GraalVM as your Java. Take note all filepaths are absolute due to a quirk of my installation. You will need to refactor all of them. Searching for roman or thesis should allow you to find them easily_
